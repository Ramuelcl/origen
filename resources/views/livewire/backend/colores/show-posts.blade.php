  ...
  <x-table>
    ...
    <table class="min-w-full divide-y divide-gray-200">
      <thead class="bg-gray-50">
        <tr>
          <th scope="col" class="px-2 py-2 text-left text-xs font-medium text-gray-500"><input name="checaTodo" type="checkbox" wire:Click="fncChecaTodo()">
          </th>

          <th scope="col" class="px-2 py-2 text-left text-xs font-medium
            text-gray-500 capitalize whitespace-nowrap cursor-pointer" wire:click="fncOrden('id')">
            id
            @if ($orden == 'id')
            @if ($sortDir == 'asc')
          ...
          <th scope="col" class="px-2 py-2 text-left text-xs font-medium
            text-gray-500 capitalize whitespace-nowrap cursor-pointer" wire:click="fncOrden('nombre')">
            nombre
            @if ($orden == 'nombre')
            @if ($sortDir == 'asc')
            <i class="fa-solid fa-sort-up"></i>
          ...
          <th scope="col" class="px-2 py-2 text-left text-xs font-medium
            text-gray-500 capitalize whitespace-nowrap cursor-pointer" wire:click="fncOrden('hexa')">
            hexa
            @if ($orden == 'hexa')
            @if ($sortDir == 'asc')
            <i class="fa-solid fa-sort-up"></i>
