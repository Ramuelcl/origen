  ...
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">Prueba 1</div>
      </div>
      <div class="px-4 py-6 sm:px-0">
        <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">Prueba 2</div>
      </div>
      <div class="px-4 py-6 sm:px-0">
        <div class="h-96 rounded-lg border-4 border-dashed border-gray-200">Prueba 3</div>
      </div>
      <!-- /End replace -->
    </div>
  </main>
